...
//    static func mapValue<InputType: FloatingPoint, OutputType: FloatingPoint>(_ value: InputType, _ inputMin: InputType, _ inputMax: InputType, _ outputMin: OutputType, _ outputMax: OutputType) -> OutputType {
//        let clampedValue = min(max(value, inputMin), inputMax)
//        guard let normalizedInput = clampedValue - inputMin as? OutputType, let normalizedRange = inputMax - inputMin  as? OutputType else {
//            return outputMin
//        }
//
//        return normalizedInput * (outputMax - outputMin) / normalizedRange + outputMin
//    }
}
