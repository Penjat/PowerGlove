...
struct PowerGloveDataObject {
    ...
    init(fingerSensor1: UInt8, fingerSensor2: UInt8, fingerSensor3: UInt8, button1State: Bool, button2State: Bool, button3State: Bool, button4State: Bool, gyroX: UInt8, gyroY: UInt8, gyroZ: UInt8, accelX: UInt8, accelY: UInt8, accelZ: UInt8) {
        ...
        self.button4State = button4State
        self.gyroX = gyroX
        self.gyroY = gyroY
        self.gyroZ = gyroZ
        self.accelX = accelX
    ...
    static func initWithData(data: Data) -> PowerGloveDataObject? {
        ...
        return PowerGloveDataObject(fingerSensor1: data[1],
                                    ...
                                    button4State:(buttonsByte & (1 << 3)) != 0,
                                    gyroX: data[5],
                                    gyroY: data[6],
                                    gyroZ: data[7],
                                    accelX: data[8],
